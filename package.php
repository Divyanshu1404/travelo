...
<section class="packages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Agra Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our Agra top selling packages!</p>
            <h2>&#8377 9,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <p>Enjoy the Emirates with unforgettable fun with our Ladakh top selling packages!</p>
            <h2>&#8377 13,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <p>Enjoy the Emirates with unforgettable fun with our Manali top selling packages!</p>
            <h2>&#8377 7,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         <div class="image">
            <img src="images/kerala1.jpg" alt="">
         </div>
         <div class="content">
            <h3>Kerala Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our Kerala top selling packages!</p>
            <h2> &#8377 12,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <p>Enjoy the Emirates with unforgettable fun with our Rajasthan top selling packages!</p>
            <h2> &#8377 18,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Haridwar Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our Haridwar  top selling packages!</p>
            <h2>&#8377 14,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      <div class="box">
         ...
         <div class="content">
            <h3>Jammu and Kashmir Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our Jammu and Kashmir top selling packages!</p>
            <h2>&#8377 7,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      <div class="box">
         <div class="image">
            <img src="images/tn.jpeg" alt="">
         </div>
         <div class="content">
            <h3>Tamil Nadu Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our Tamil Nadu top selling packages!</p>
            <h2>&#8377 7,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         <div class="image">
            <img src="images/mumbi.jpg" alt="">
         </div>
         <div class="content">
            <h3> Mumbai Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our Mumbai top selling packages!</p>
            <h2>&#8377 11,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
